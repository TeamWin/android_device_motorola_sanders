...
BOARD_MKBOOTIMG_ARGS :=  --ramdisk_offset 0x01000000 --tags_offset 0x00000100 --kernel_offset 0x00008000 --dt device/motorola/sanders/prebuilt/dt.img
...
# Recovery
TARGET_RECOVERY_FSTAB := device/motorola/sanders/recovery/root/etc/twrp.fstab
